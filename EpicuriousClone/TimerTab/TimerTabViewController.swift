...
extension TimerTabViewController:UITableViewDelegate {
    ...
    func setSelectedIngredients(selectedRow row:Int) {
        ...
        case 1:
            ...
            selectedIngredientsArray.append(CategoriesModel(title: "Brussets Sprouts", image: Constants.Images.BRUSSEL_SPROUTS))
            selectedIngredientsArray.append(CategoriesModel(title: "Butternet Squash", image: Constants.Images.BUTTERNET_SQUASH))
        ...
        case 2:
            ...
            selectedIngredientsArray.append(CategoriesModel(title: "Chicken Breast, Boneless and Skiless", image: Constants.Images.CHICKEN_BREASTS_BONELESS_AND_SKINLESS))
            ...
            selectedIngredientsArray.append(CategoriesModel(title: "Pork Chops, Bone_In", image: Constants.Images.PORK_CHOPS_BONE_IN))
